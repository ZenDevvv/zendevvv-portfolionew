...
export const experiences = [
  {
    ...
    tasks: [
      ...
      "Built a robust Learning Management System (LMS) using the MERN stack (MongoDB, Express.js, React, Node.js), delivering a scalable platform for efficient course management and user engagement."
    ]
  },
  {
